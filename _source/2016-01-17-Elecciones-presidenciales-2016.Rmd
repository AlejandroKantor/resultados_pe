...
#setwd("/Users/akantorb/Documents/proyectos independientes/resultados_pe/resultados_pe/gh-pages")

#load("/Users/akantorb/Documents/proyectos #independientes/resultados_pe/resultados_pe//data/encuestasPrimeraVueltaLong.RData")


```

El siguiente gráfico combina las encuestas de intensión de voto. Actualizado el `r I(k_fecha_mas_reciente)`.
...
Estimado de »Resultados.pe« al cierre del trabajo de campo de la encuesta más reciente: `r I(k_fecha_encuesta)`. 
